...
<div class="container mx-auto">
    <div class="flex justify-center items-center h-screen relative">
        ...
        <!-- Main modal -->
        <div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden z-[99] overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 justify-end items-center w-full md:inset-0 h-screen max-h-full bg-[#00000057]">
            <div class="relative p-4 w-full max-w-2xl max-h-modal-fullscreen-md-down">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow-sm h-[400px]">
                    <!-- Modal header -->
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200">
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="default-modal" id="close-btn">
                    ...
                    <!-- Modal body -->
                    <div class="p-4 md:p-5 space-y-4" id="wrapper-chating">
