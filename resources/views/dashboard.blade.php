    ...
    <div class="grid grid-cols-2 gap-5">
        <div class="w-full">
            <div class="flex justify-start items-center h-screen relative left-0 right-0">
                <div class="chat-container relative bg-white shadow-lg overflow-hidden p-4">
            ...
            <form id="searchForm" class="w-[400px] z-50 shadow-lg">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="default-search" name="search"
                        class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-[#006DAE] focus:border-[#006DAE]"
                        placeholder="Search ..." />
                    <button type="submit"
                        class="text-white absolute right-2.5 bottom-2.5 bg-[#006DAE] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">
                        Search
                    </button>
                </div>
            </form>
