            ...
            <form id="searchForm" class="w-[400px] z-50 shadow-lg">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="default-search" name="search"
                        ...
                        placeholder="Search ..." />
                    <button type="submit"
                        class="text-white absolute right-2.5 bottom-2.5 bg-[#006DAE] hover:bg-[#005B8C] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">
                        Search
                    </button>
                </div>
            </form>
